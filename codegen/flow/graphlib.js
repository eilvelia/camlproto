...
declare export var alg: {
	 ...
	 */
	prim(graph: Graph, weightFn: (e: Edge) => number): Graph;
	 ...
	 */
	preorder(graph: Graph, vs: string[]): string[];
	 ...
	 * @returns the nodes in the order they were visited as a list of their names.
	 */
	postorder(graph: Graph, vs: string[]): string[];
}
